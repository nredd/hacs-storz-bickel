...
# read+notify status source only — NOT a write target; use AUTO_SHUTOFF_ON/OFF triggers
...
VOLCANO_UUID_AUTO_SHUTOFF_ON: Final = "10110011-5354-4f52-5a26-4249434b454c"
VOLCANO_UUID_AUTO_SHUTOFF_OFF: Final = "10110012-5354-4f52-5a26-4249434b454c"
