...
- `entity/` — Base entity class (`StorzBickelEntity`)
...
- Entity MRO: `(PlatformEntity, StorzBickelEntity)` — order matters
...
- Debug level: `custom_components.storz_bickel: debug` in `config/configuration.yaml`
